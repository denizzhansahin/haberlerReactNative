  ...
  return (
    <ScrollView>
      <View>
        ...
        <Card style={{ margin: 5 }}>
          <Card.Title title="İnternet Sitesi" subtitle="https://haberler-81678.web.app/"></Card.Title>
          <Card.Actions>
            <Button onPress={() => Linking.openURL('https://haberler-81678.web.app/')}>İnternet Sitesini Ziyaret Et</Button>
          </Card.Actions>
        </Card>
        <Card style={{ margin: 5 }}>
