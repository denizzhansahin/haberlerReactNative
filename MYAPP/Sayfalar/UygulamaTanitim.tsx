            ...
            >
                <View style={{ height: "100%", width: "100%", flexDirection: "column" }}>
                    ...
                    <View style={{ flex: 10, marginTop: 0, width: "100%", height: 450 }}>
                        <Image style={{ height: "100%", width: "100%", borderRadius: 10 }} source={require('../Components/haber_icon.png')} />
                    </View>

                    <View style={{ marginTop:10,flexDirection:"column",flex: 10, margin: 1, width: "100%", height: "auto" }}>
                        <Text variant='titleMedium' style={{ color: "white", fontSize: 20, fontWeight: "bold", textAlign:"center"}}>Haberler Uygulaması</Text>
                        <Text variant='bodyLarge' style={{textAlign:"center",color: "white", fontSize: 15, fontWeight: "bold" }}>
                                Haberler uygulaması ile birlikte istediğiniz kategorideki istediğiniz haberi hızlı ve kolayca okuyabileceksiniz. Yazar ekibimiz ile sizlerin okuması için
